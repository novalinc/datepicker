...
@Component({
    ...
    template: `
        <div class="row">
            ...
            <div class="col-md-4" tabindex="0" (focus)="onFocus()" (blur)="onBlur()" >
                <div class="input-group datepicker-control" >{{prettyDate()}} <span class="glyphicon glyphicon-calendar"></span></div>
                    <div *ngIf="opened" class="bootstrap-datetimepicker-widget dropdown-menu" style="display: block; bottom: auto;">
    ...
    styles: [`
        ...
        .bootstrap-datetimepicker-widget .datepicker-switch::after {
        position: absolute;
        width: 1px;
        height: 1px;
        margin: -1px;
        ...
        .bootstrap-datetimepicker-widget .datepicker-switch td {
        padding: 0;
        margin: 0;
        height: auto;
        width: auto;
        ...
        .bootstrap-datetimepicker-widget table td.blurred {
        color: #777777;
        }
